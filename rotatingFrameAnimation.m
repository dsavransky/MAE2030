...
%add labels
le3 = text(1,-0.05,0.05,'$\mathbf{e}_3$','FontSize',18,...
    'Interpreter','LaTex');
lb3 = text(1,0.07,0,'$\mathbf{b}_3$','FontSize',18,...
    'Interpreter','LaTex');
le1 = text(0,0.99,0.03,'$\mathbf{e}_1$','FontSize',18,...
    'Interpreter','LaTex');
le2 = text(0,0.02,0.98,'$\mathbf{e}_2$','FontSize',18,...
    'Interpreter','LaTex');
lI = text(0,-0.08,1.01,'$\mathcal{I}$','FontSize',18,...
    'Interpreter','LaTex');
lb1 = text(0,cos(th0*pi/180),sin(th0*pi/180),'$\mathbf{b}_1$',...
    'FontSize',18,'Interpreter','LaTex');
lb2 = text(0,-sin(th0*pi/180)+0.025,cos(th0*pi/180),'$\mathbf{b}_2$',...
    'FontSize',18,'Interpreter','LaTex');
