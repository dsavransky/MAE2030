...
text(0,-0.15,1,'$$\mathbf{\hat{e}}_3$$','FontName','Times',...
    'FontSize',24,'Interpreter','Latex')
text(1,-0.15,0,'$$\mathbf{\hat{e}}_1$$','FontName','Times',...
    'FontSize',24,'Interpreter','Latex')
text(0,0.85,-0.075,'$$\mathbf{\hat{e}}_2$$','FontName','Times',...
    'FontSize',24,'Interpreter','Latex')
...
text(cos(thr),sin(thr)+0.01,-0.05,'$$\mathbf{\hat{e}}_r$$','FontName',...
    'Times','FontSize',24,'Interpreter','Latex')
text(-sin(thr)-0.1,cos(thr)+0.02,-0.05,'$$\mathbf{\hat{e}}_\theta$$',...
    'FontName','Times','FontSize',24,'Interpreter','Latex')
if ~nopause; pause; end
...
text(cos(thr)*cos(phir),sin(thr)*cos(phir),-sin(phir)-0.05,...
    '$$\mathbf{\hat{e}}_\phi$$','FontName','Times',...
    'FontSize',24,'Interpreter','Latex')
text(cos(thr)*sin(phir),sin(thr)*sin(phir),cos(phir)-0.1,...
    '$$\mathbf{\hat{e}}_\rho$$','FontName','Times',...
    'FontSize',24,'Interpreter','Latex')
