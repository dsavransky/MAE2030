...
If you wish to execute these notebooks, you will need Python >= 3.10 and Jupyter (see https://jupyter.org/install).  You will also need the `sympy` and `sympyhelpers` packages.  You can install both by running:
